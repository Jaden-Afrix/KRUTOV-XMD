 ...
 * 
 * Credits:
 * - Baileys Library by KRUTOV
 * - Pair Code implementation inspired by KRUTOV
 */
const fs = require('fs')
...
async function writeExifImg(media, metadata) {
  ...
  if (metadata.packname || metadata.author) {
    ...
    const json = { "sticker-pack-id": `https://github.com/Jaden-Afrix/KRUTOV-XMD`, "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : [""] }
